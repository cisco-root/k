...
function closeConnection($message = 'Lite source is runinng . . .'){
...
yield $MadelineProto->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "سرورم آنلاینم :)"]);
  }
    if ($text == '/status'){
...
'message'=> "[ᴀʟʟ ɢʀᴏᴜᴘ ᴍᴇssᴀɢᴇs ᴡᴇʀᴇ ᴅᴇʟᴇᴛᴇᴅ !](https://T.me/Source_Lite)", 
'parse_mode'=> 'markdown' ,
